...
class HybridRetriever:
    ...
    def __init__(
        ...
        barrier_control_ids: list[str] | None = None,
    ) -> None:
        ...
        # Parallel list of control_ids (same length as barrier_incident_ids)
        self._barrier_control_ids: list[str] = (
            barrier_control_ids if barrier_control_ids is not None
            else [""] * len(barrier_incident_ids)
        )
        ...
        for b_idx, barrier_rank, b_score, parent_iid in candidates:
            ...
            results.append(
                RetrievalResult(
                    ...
                    control_id=self._barrier_control_ids[b_idx],
