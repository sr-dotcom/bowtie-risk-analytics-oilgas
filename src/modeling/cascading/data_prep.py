...
def _write_profile(
    ...
    *,
    ...
    lines = [
        ...
        "",
        f"> Generated by `src/modeling/cascading/data_prep.py`  ",
        f"> Source: `data/models/cascading_input/barrier_model_dataset_base_v3.csv`",
        "",
        "## Drop Audit",
        "",
        ...
        f"`lod_industry_standard == 'Other'` AND `lod_numeric == 99` simultaneously.",
