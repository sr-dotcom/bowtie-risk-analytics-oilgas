...
| G-AR-4 | All joblib.dump targets data/models/artifacts/ | **AGREE** | Four joblib.dump call sites: `train.py:265` (logreg_path), `feature_engineering.py:268` (encoder_path), `archive/disabled-experiments/hf_recovery.py:408` (`_ARTIFACTS_DIR/xgb_cascade_y_hf_fail_pipeline.joblib` — moved per AUDIT_TRIAGE F015), `cascading/train.py:152` (`_ARTIFACTS_DIR/...`). All resolve to `data/models/artifacts/`. | `src/modeling/train.py:265`, `src/modeling/feature_engineering.py:268`, `archive/disabled-experiments/hf_recovery.py:31–408`, `src/modeling/cascading/train.py:34–152` | |
